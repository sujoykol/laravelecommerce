...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{  asset('public/fontend/assets/images/icons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{  asset('public/fontend/assets/images/icons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('public/fontend/assets/images/icons/favicon-16x16.png')}}">
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{ asset('public/fontend/assets/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ asset('public/fontend/assets/css/plugins/owl-carousel/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{ asset('public/fontend/assets/css/plugins/magnific-popup/magnific-popup.css') }}">
    <!-- Main CSS File -->
...
<body>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="{{ url('/') }}" class="logo">
                            <img src="{{ asset('public/fontend/assets/images/logo.png')}}" alt="Molla Logo" width="105" height="25">
                        </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="public/fontend/assets/images/products/cart/product-1.jpg" alt="product">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="public/fontend/assets/images/products/cart/product-2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="{{  asset('public/fontend/assets/images/logo-footer.png')}}" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		...
	        		<figure class="footer-payments">
	        			<img src="{{ asset('public/fontend/assets/images/payments.png') }}" alt="Payment methods" width="272" height="20">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="public/fontend/assets/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{ asset('public/fontend/assets/images/popup/newsletter/img-1.jpg')}}" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{ asset('public/fontend/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{ asset('public/fontend/assets/js/jquery.hoverIntent.min.js')}}"></script>
    <script src="{{ asset('public/fontend/assets/js/jquery.waypoints.min.js')}}"></script>
    <script src="{{ asset('public/fontend/assets/js/superfish.min.js')}}"></script>
    <script src="{{ asset('public/fontend/assets/js/owl.carousel.min.js')}}"></script>
    <script src="{{ asset('public/fontend/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <!-- Main JS File -->
